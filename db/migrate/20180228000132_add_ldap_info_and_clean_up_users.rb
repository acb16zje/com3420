class AddLdapInfoAndCleanUpUsers < ActiveRecord::Migration[5.1]
  def change
    ...
    # unnecessary_columns = %w(reset_password_token reset_password_sent_at remember_created_at) & existing_columns
